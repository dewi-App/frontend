...
class _RestoPageState extends State<RestoPage> {
  final List<Map<String, dynamic>> listResto = [
    {"name": "Resto Cibiuk", "rating": 4},
    {"name": "Resto Buimas", "rating": 3},
    {"name": "Resto Pagisore", "rating": 5},
    {"name": "Resto Siangmalam", "rating": 4},
    {"name": "Resto Aku", "rating": 5},
  ];
