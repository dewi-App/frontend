...
class _MuseumPageState extends State<MuseumPage> {
  final List<Map<String, dynamic>> listMuseum = [
    {"name": "Museum Sribaduga", "rating": 4},
    {"name": "Museum Balkot", "rating": 3},
    {"name": "Museum Bandung", "rating": 5},
    {"name": "Museum Art", "rating": 4},
    {"name": "Museum Asia", "rating": 5},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Semua Museum'),
      ),
      body: ListView(
        children: listMuseum.map((data) {
          return Column(
